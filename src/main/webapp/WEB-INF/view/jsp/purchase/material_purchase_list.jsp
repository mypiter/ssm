		...
		<div data-options="region:'center',iconCls:'icon-reload',title:'',split:true,border:false,bodyCls:'border_left_right'">
                ...
                <table data-toggle="topjui-datagrid"
                    ...
                    <tr>
                        ...
                        <th data-options="field: 'ticket_object', title: '规格', sortable: true"></th>
                        <th data-options="field: 'ticket_name', title: '单价', sortable: true"></th>
                        <th data-options="field: 'ticket_money', title: '数量', sortable: true"></th>
                        <th data-options="field: 'carton_name', title: '总价', sortable: true"></th>                 
                        <th data-options="field: 'order_num', title: '采购时间', sortable: true"></th>                      
                        <th data-options="field: 'carton_total', title: '采购人', sortable: true"></th>
...
<!-- 表格工具栏开始 -->
	<div id="userDg-toolbar" class="topjui-toolbar"
       ...
       dialog:{
           ...
           height: 500,
           id:'userAddDialog',
            href:_ctx + '/jsp/purchase/add_material_purchase.jsp',
           buttonsGroup:[
