...
<head>
    ...
    <meta http-equiv="description" content="对账 单报表">
</head>
<style type="text/css">
    html,body {
        margin:0;
...
<script language="javascript" type="text/javascript">
    ...
    CreatePrintViewerEx("100%", "100%", "${pageContext.request.contextPath}/js"+durl, "/Mian/selectDs/?custom="+encodeURI(data)+"&stratime="+startTime+"&endtime="+endTime+"&coid="+coid, true, "");
    /*获取地址栏参数的方法实现*/
