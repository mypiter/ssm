...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script language="javascript" type="text/javascript">
        var data=getQueryString("deliveryNumber");
        var style=getQueryString("deliveryStyle");
        var sty = new Array();
        sty=style.split(",");
        ...
        CreatePrintViewerEx("100%", "100%", "${pageContext.request.contextPath}/js"+sty[0], "/Mian/selectPs/?deliveryNumber="+data+"&coid="+coid, true, "");
        /*获取地址栏参数的方法实现*/
