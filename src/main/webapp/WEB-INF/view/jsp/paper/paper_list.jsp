    ...
    <div data-options="region:'center',iconCls:'icon-reload',title:'',split:true,border:false,bodyCls:'border_left_right'">
        ...
        <table data-toggle="topjui-datagrid"
            ...
            <tr>
                ...
                <th data-options="field:'number', title: '纸张名称',sortable:true"></th>
                <th data-options="field:'name', title: '代号',sortable:true"></th>
                 <th data-options="field:'number', title: '克重（g/㎡）',sortable:true"></th>
                <th data-options="field:'name', title: '单价（元/㎡）',sortable:true"></th>
            </tr>
            </thead>
        </table>
    </div>
