...
<div data-toggle="topjui-layout" data-options="fit:true">
    <div data-toggle="topjui-tabs"
        ...
        <div title="客户模板" data-options="region:'west',id:'tab2',type:'panel',
 ...
 <form data-toggle="topjui-form" data-options="id:'formId'" >
    <table class="editTable">
        ...
        <tr>
            ...
            <td><input type="text" name="print_image" data-toggle="topjui-filebox" data-options="buttonIcon:'fa fa-folder',id:'print_image',width:'153px'">
        ...
        <div title="本公司模板" data-options="id:'tab3',type:'panel',
        iconCls:'fa fa-th',footer:'#footer2'">
         <form data-toggle="topjui-form" data-options="id:'formId2'" >
    <table class="editTable"> 
        <tr>
            <td colspan="4">
                <div class="divider">
        ...
        <tr>
            <td class="label">纸箱名称</td>
            <td><input type="text" name="model_name" data-toggle="topjui-textbox" data-options="id:'model_name',required:true" value=""></td>
            <td class="label">箱型</td>
            <td><input type="text" name="carton_type" data-toggle="topjui-textbox" data-options="id:'carton_type',required:true" value=""></td>
            <td class="label">纸箱编号</td>
            <td><input type="text" name="model_number" data-toggle="topjui-textbox" data-options="id:'model_number'" value=""></td>
        ...
        <tr id="fu4">
            ...
            <td colspan="3">
             ...
             <div id="footer2"  style="padding: 5px;text-align: right;">
