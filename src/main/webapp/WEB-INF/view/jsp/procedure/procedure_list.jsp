...
<head>
   ...
   <script>
     ...
     function deleteCartonType(){
       ...
       /* $("#userDg").iDatagrid({
            id: 'userDg',
            url: '${pageContext.request.contextPath}/data/procedure.json',
           
            columns: [[
                {field: 'production_id', title: 'UID', checkbox: true},
               
                {field: 'order_account', title: '订单号', sortable: true},
                {field: 'company_name', title: '客户公司', sortable: true},
                ...
                {field: 'production_num', title: '生产数量', sortable: true},
                {field: 'loss_num', title: '损耗数量', sortable: true},
                {field: 'loss_reason', title: '损耗原因', sortable: true},
                {field: 'time', title: '录入时间', sortable: true},
                {field: 'user_name', title: '生产人', sortable: true}
...
<div data-toggle="topjui-layout" data-options="fit:true">
    <div data-options="region:'west',title:'',split:true,border:false,width:'15%',iconCls:'fa fa-sitemap',headerCls:'border_right',bodyCls:'border_right'">
        ...
        <table data-toggle="topjui-treegrid"
			   ...
			   childTabs: [{id:'centerTabs'}]">
            <thead>
            <tr>
                <th data-options="field:'uuid',title:'UUID',checkbox:true"></th>
                <th data-options="field:'text',title:'工序列表',width:100"></th>
            </tr>
            </thead>
        </table>
    </div>
    <div data-options="region:'center',iconCls:'icon-reload',title:'',split:true,border:false,bodyCls:'border_left'">
        <div data-toggle="topjui-tabs"
            ...
            <div title="今日产量" data-options="id:'tab0',iconCls:'fa fa-th'">
                <!-- datagrid表格 -->
                <table data-toggle="topjui-datagrid"
                    ...
                    <thead>
                    <tr>
                        <th data-options="field:'production_id',title:'UUID',checkbox:true"></th>
                        ...
                        <th data-options="field:'production_num',title:'生产数量',sortable:true"></th>
                        <th data-options="field:'loss_num',title:'损耗数量',sortable:true"></th>
                        <th data-options="field:'loss_reason',title:'损耗原因',sortable:true"></th>
                        <th data-options="field:'time',title:'录入时间',sortable:true"></th>
                        <th data-options="field:'user_name',title:'生产人',sortable:true"></th>
                    </tr>
                    </thead>
                </table>
            </div>
            <div title="每日产量统计" data-options="id:'tab1',iconCls:'fa fa-th'">
                <!-- datagrid表格 -->
               
         
               
                <table data-toggle="topjui-datagrid"
                       data-options="id:'userDg1',
                               initCreate: false,
                               fitColumns:true,
						       url:'${pageContext.request.contextPath}/data/procedure.json'">
                    <thead>
...
<!-- 表格工具栏开始 -->
 <div id="userDg1-toolbar" class="topjui-toolbar"
     data-options="grid:{
           type:'datagrid',
           id:'userDg1'
       }">
       
       起始时间:&nbsp;&nbsp;<input type="text" name="birthday" data-toggle="topjui-datebox">&nbsp;&nbsp;&nbsp;&nbsp;
              结束时间:&nbsp;&nbsp;<input type="text" name="birthday" data-toggle="topjui-datebox">
