		...
		<div data-options="region:'center',iconCls:'icon-reload',title:'',split:true,border:false,bodyCls:'border_left_right'">
                ...
                <table data-toggle="topjui-datagrid"
                    ...
                    <tr>
                        ...
                        <th data-options="field: 'ticket_accout', title: '纸箱调整前单价', sortable: true"></th>
                        <th data-options="field: 'ticket_accout', title: '纸箱调整后单价', sortable: true"></th>
                        <th data-options="field: 'order_num', title: '纸箱调整前库存数量', sortable: true"></th>
                        <th data-options="field: 'order_num', title: '纸箱调整后库存数量', sortable: true"></th>
                        <th data-options="field: 'ticket_accout', title: '纸箱调整前总金额', sortable: true"></th>
                        <th data-options="field: 'ticket_accout', title: '纸箱调整后总金额', sortable: true"></th>
                        <th data-options="field: 'order_num', title: '纸箱调整类型', sortable: true"></th>
                        <th data-options="field: 'order_num', title: '纸箱调整时间', sortable: true"></th>
                        <th data-options="field: 'order_num', title: '纸箱调整备注', sortable: true"></th>
