        ...
        <!-- datagrid表格 -->
         <table data-toggle="topjui-datagrid"
            ...
            <tr>
                ...
                <th data-options="field:'carton_type',title:'配送数量',sortable:true"></th>
                <th data-options="field:'making_price',title:'单价',sortable:true"></th>
                <th data-options="field:'order_total',title:'总金额',sortable:true"></th>
        ...
        <div data-toggle="topjui-tabs"
            ...
            <div title="收款记录"
                 data-options="id:'eastTab0',iconCls:'fa fa-eye',
					 href: _ctx + '/jsp/finance/Record_receipts.jsp?transaction_id={uuid}'"></div>
