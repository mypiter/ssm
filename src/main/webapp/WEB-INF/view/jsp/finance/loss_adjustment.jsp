...
<div data-toggle="topjui-layout" data-options="fit:true">
    ...
    <tr>
        ...
        <th data-options="field:'type',title:'采购单号',sortable:true"></th>
         <th data-options="field:'createTime',title:'供应商名称',sortable:true"></th>
        <th data-options="field:'code',title:'采购数量',sortable:true"></th>
        ...
        <th data-options="field:'kuqu',title:'应付金额',sortable:true,editor:{type:'textbox',options:{required:true,height:30}}"></th>
        <th data-options="field:'kuqu',title:'已付金额',sortable:true,editor:{type:'textbox',options:{required:true,height:30}}"></th>     
    </tr>
    </thead>
</table>
    </div>
