  ...
  <div data-options="region:'center',title:'',fit:false,split:true,border:false,bodyCls:'border_right_bottom'">
                ...
                <table data-toggle="topjui-datagrid"
                       data-options="id:'userDg',
					    ...
					    selectOnCheck:false,
					    checkOnSelect:false,
                       	url:'/LoanBack/LoanBackList/',
			            childTabs: [
                            {id:'eastTabs'}
                        ]">
                    <thead>
                    <tr>
                        <th data-options="field: 'receiptRecordId', title: 'UID', checkbox: true"></th>
                        <th data-options="field: 'customName', title: '客户名称', sortable: true"></th>
                        <th data-options="field: 'receiptMoney', title: '已付金额', sortable: true"></th>
                        <th data-options="field: 'receiptType', title: '支付方式', sortable: true,
                        ...
                        <th data-options="field: 'receiptAcceptanceTicket', title: '承兑票号', sortable: true"></th>
                        <th data-options="field: 'receiptAcceptanceDate', title: '承兑日期', sortable: true"></th>
                        <th data-options="field: 'receiptTime', title: '录入时间', sortable: true"></th>
                        <th data-options="field: 'receiptRemarks', title: '备注', sortable: true"></th>
                    </tr>
                    </thead>
                </table>
            </div>
	...
	<div id="userDg-toolbar" class="topjui-toolbar"
       ...
       tab:{
		...
		<a href="javascript:void(0)" data-toggle="topjui-menubutton"
            ...
            tab: {
                title:'调整',
                href: '/LoanBack/edit/?url=/finance_register/financial_load&receiptRecordId={receiptRecordId}'
            }">调整</a>
            <%--<a href="javascript:void(0)"
            data-toggle="topjui-menubutton"
