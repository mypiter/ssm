    ...
    <div data-toggle="topjui-panel" title="" data-options="fit:true,iconCls:'icon-ok',footer:'#footer'">
		<form class="hidden" method="post" data-toggle="topjui-form" data-options="id:'formId',
			...
			<div style="margin: 20px 0; width: 100%;">
				...
				纸箱规格<input id="chang" type="text" name="" data-toggle="topjui-numberbox" data-options="min:0,max:99999999,prompt:'长'" style="width: 70px;">
				X&nbsp;<input id="k" type="text" name="" data-toggle="topjui-numberbox" data-options="min:0,max:99999999,prompt:'宽'" style="width: 70px;">
				X&nbsp;<input id="h" type="text" name="" data-toggle="topjui-numberbox" data-options="min:0,max:99999999,prompt:'高'" style="width: 70px;">
			...
			<div style="margin: 20 0;">
				调整日期<input type="text" id="riqi" name="rkdate" data-toggle="topjui-datetimebox" data-options="onChange:function(newValue,oldValue){console.log(newValue);}" style="width: 180px;">
		  		...
		  		异常类型<input type="text" name="yc" data-toggle="topjui-combobox" data-options="data:[{value:1,text:'原材料报废'},{value:2,text:'生产报废'}],panelHeight:70" style="width: 130px;">
			...
			<div>
				...
				<table class="layui-table" lay-data="{url:'/CartonStock/findAll/',page:true, id:'test3',height:600}" lay-filter="test3">
				  <thead>
				    <tr>
				      ...
				      <th lay-data="{field:'materialScience', minWidth: 150}">材质</th>
				      <th lay-data="{field:'pitType', width:80}">楞型</th>
				      <th lay-data="{field:'stockNum',  minWidth: 100}">库存数</th>
				      <th lay-data="{field:'number', sort: true, edit: 'text'}">调整数</th>
				      <th lay-data="{field:'tp', sort: true, edit: 'text'}">托盘数</th>
				      <th lay-data="{field:'cent', sort: true, edit: 'text'}">备注</th>
				    </tr>
				  </thead>
				</table>
				...
				layui.use('table', function(){
                    ...
                    if(value!=""){
                        if(field=="number"){
                            layer.msg('[订单: '+ data.orderAccount+']入库 '+ value +' 片纸箱');
                        }else{
                            layer.msg('[订单: '+ data.orderAccount+']报损数量更改为：'+ value);
                        }
                    }
                    if(data.number==undefined){//如果为undefined的话在生成对象的时候就会被自动过滤
                        data.number = "";
                    }
                    if(data.tp==null||data.tp==""){//无论是undefined还是null都统一等于空字符串“”
                        data.tp = "0";
                    }
					if(data.cent==null){//无论是undefined还是null都统一等于空字符串“”
						data.cent = "无";
					}
			    ...
			    <a href="#"  id="tijiao" style="display:none;"
			       ...
			       data-options="id:'submitBtn',
			                   ...
			                   form:{
			                       id:'formId',
			                       method:'submit',
			                       url:'/CartonRecord/addCartonRecord/',
			                   }">提交</a>
