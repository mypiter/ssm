		...
		<div data-options="region:'center',iconCls:'icon-reload',title:'',split:true,border:false,bodyCls:'border_left_right'">
                ...
                <table data-toggle="topjui-datagrid"
                    ...
                    <tr>
                        ...
                        <th data-options="field: 'ticket_object', title: '数量', sortable: true"></th>
                        <th data-options="field: 'ticket_name', title: '单价', sortable: true"></th>
                        <th data-options="field: 'ticket_money', title: '总价', sortable: true"></th>
                        <th data-options="field: 'ticket_money', title: '时间', sortable: true"></th>  
                        <th data-options="field: 'ticket_money', title: '出库还是入库', sortable: true"></th>               
