...
<html>
  ...
  <body>
  	...
  	<h3 align="center" style="">出库详情</h3><br>
  			...
  			<table id="tab" border="1px" bordercolor="#000000" cellspacing="0px" >
  				<tr >
  					<td colspan="4"  align="center">
  						...
  						<h4><b>当前为订单号是<strong class="str1"></strong>的出库详细信息</b></h4>
  					</td>
  					
  				</tr>
  				<tr >
  					<td style="width:15%" align="center"><b>订单号</b></td>
  				    <td style="width:18% " align="center" colspan="3"></td>
  				
  				  
  					
  				</tr>
  				<tr >
  					<td style="width:15%" align="center"><b>客户名称</b></td>
  				    <td style="width:18% " align="center"></td>
  				    <td style="width:15%" align="center"><b>业务员</b></td>
  				    <td style="width:18% " align="center"></td>
  				...
  				<tr >
  					 <td style="width:15%" align="center"  ><b>长宽高</b></td>
  				    <td style="width:18% " align="center"></td>
  					<td style="width:15%" align="center"><b>产品名称 </b></td>
  					<td style="width:18%" align="center"></td>
  					
  				</tr>
  				<tr >
  					 <td style="width:15%" align="center"><b>楞型</b></td>
  					<td style="width:18%" align="center"></td>
  					<td style="width:15%" align="center"><b>材质</b></td>
  				    <td style="width:18% " align="center"></td>

  				</tr>
  				<tr >
  					 <td style="width:15%" align="center"><b>订单数量</b></td>
  				    <td style="width:18% " align="center"></td>
  				    <td style="width:15%" align="center"><b>出库数量</b></td>
  					<td style="width:18%" align="center"></td>
  				</tr>
  				<tr >
  					<td style="width:15%" align="center"><b>出库时间</b></td>
  					<td style="width:18%" align="center"></td>
  				    <td style="width:15%" align="center"><b>库区位置</b></td>
  					<td style="width:18%" align="center"></td>
  				    
  					
  				</tr>
  				<tr >
  					<td style="width:15%" align="center"><b>托盘数</b></td>
  				    <td style="width:18% " align="center"></td>
  					<td style="width:15%" align="center"><b>单价</b></td>
  					<td style="width:18%" align="center"></td>
  					
  				</tr>
  				<tr >
  					<td style="width:15%" align="center"><b>总金额 </b></td>
  				    <td style="width:18% " align="center"></td>
  				    <td style="width:15%" align="center"><b>配送人</b></td>
  					<td style="width:18%" align="center"></td>
  				...
  				<tr >
  					 <td style="width:15%" align="center"><b>配送人联系方式</b></td>
  					<td style="width:18%" align="center"></td>
  					 <td style="width:15%" align="center"><b>配送车牌号<b></td>
  					<td style="width:18%" align="center"></td>
  				
  					
  				</tr>
  				<tr >
  					<td style="width:15%" align="center"><b>配送时间</b></td>
  				    <td style="width:18% " align="center"></td>
  				   	<td style="width:15%" align="center"><b>配送数量 </b></td>
  				    <td style="width:18% " align="center"></td>
  				   
  					
  				</tr>
  				<tr >
  					<td style="width:15%" align="center"><b>收货人</b></td>
  				    <td style="width:18% " align="center"></td>
  				    <td style="width:15%" align="center"><b>收货人联系方式</b></td>
  					<td style="width:18%" align="center"></td>
  					
  				</tr>
  				<tr >
  					<td style="width:15%" align="center"><b>签收数量</b></td>
  				    <td style="width:18% " align="center"></td>
  				    <td style="width:15%" align="center"><b>未签收数量</b></td>
  					<td style="width:18%" align="center"></td>
  					
  				</tr>
  				<tr >
  					<td style="width:15%" align="center"><b>报废</b></td>
  				    <td style="width:18% " align="center"></td>
  				    <td style="width:15%" align="center"><b>少数</b></td>
  					<td style="width:18%" align="center"></td>
  					
  				</tr>
  				<tr >
  					<td style="width:15%" align="center"><b>退货</b></td>
  				    <td style="width:18% " align="center"></td>
  				    <td style="width:15%" align="center"><b></b></td>
  					<td style="width:18%" align="center"></td>
  					
  				</tr><tr >
  					<td style="width:15%" align="center"><b>未签收原因</b></td>
  				    <td style="width:18% " align="center" height="50px" colspan=3" ></td>
  					
  				</tr>
  				<tr >
  					<td style="width:15%" align="center"><b>收货地址</b></td>
  				    <td style="width:18% " align="center"  height="50px"  colspan=3" ></td>
  					
  				</tr>
  				<tr >
  					<td style="width:15%" align="center"><b> 备注</b></td>
  				    <td style="width:18% " align="center"  height="70px"  colspan=3"></td>
