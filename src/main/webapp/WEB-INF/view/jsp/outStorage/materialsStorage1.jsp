            ...
            <div data-options="region:'center',title:'',fit:false,split:true,border:false,bodyCls:'border_right_bottom'"
                ...
                <table data-toggle="topjui-datagrid"
                       data-options="id:'userDg',
                        ...
                        fitColumns:true,
                        rownumbers: true,
                        url:'${pageContext.request.contextPath}/json/demo/materialsStorage.json',
			            childTabs: [
                    ...
                    <thead>
                    <tr>
                        <th data-options="field: 'making_storage_id', title: 'UUID', checkbox: true"></th>
                        <th data-options="field: 'making_name', title: '物材名称', sortable: true"></th>
                        <th data-options="field: 'storage_spec', title: '物材规格', sortable: true"></th>
                        ...
                        <th data-options="field: 'storage_name', title: '所属库名', sortable: true"></th>
                        <th data-options="field: 'type', title: '出库还是入库', sortable: true"></th>
                    </tr>
                    </thead>
                </table>
            </div>
...
<div id="userDg-toolbar" class="topjui-toolbar"
     ...
     <a href="javascript:void(0)"
       ...
       dialog:{
           ...
           height: 350,
           id:'userAddDialog',
           href:_ctx + '/jsp/outStorage/materialsStorageAdd.jsp',
           buttonsGroup:[
    ...
    <a href="javascript:void(0)"
       ...
       data-options="method: 'openDialog',
            ...
            dialog: {
                width: 750,
                height: 350,
                href: _ctx + '/jsp/outStorage/materialsStorageAdd.jsp?transaction_id={uuid}',
                url: _ctx + '/json/demo/materialsStorageEdit.json?transaction_id={uuid}',
                buttonsGroup: [
                    {
                        text: '更新',
