            ...
            <div data-options="region:'center',title:'',fit:false,split:true,border:false,bodyCls:'border_right_bottom'"
                ...
                <table data-toggle="topjui-datagrid"
                       data-options="id:'userDg',
                        ...
                        fitColumns:true,
                        rownumbers: true,
                        url:'${pageContext.request.contextPath}/json/demo/cartonPur.json',
			            childTabs: [
                    ...
                    <tr>
                        ...
                        <th data-options="field: 'purchase_id', title: '关联纸板id', sortable: true"></th>
    ...
    <a href="javascript:void(0)"
       ...
       data-options="method: 'openDialog',
            ...
            dialog: {
                ...
                url: _ctx + '/json/demo/cartonPurEdit.json?transaction_id={uuid}',
                buttonsGroup: [
                    {
                        text: '更新',
