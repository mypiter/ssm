		...
		<div data-options="region:'center',iconCls:'icon-reload',title:'',split:true,border:false,bodyCls:'border_left_right'">
                ...
                <table data-toggle="topjui-datagrid"
                    ...
                    <tr>
                        ...
                        <th data-options="field: 'order_account', title: '客户名称', sortable: true"></th>
                        <th data-options="field: 'order_account', title: '产品名称', sortable: true"></th>
                        <th data-options="field: 'material_science', title: '材质/楞型', sortable: true"></th>
                        <th data-options="field: 'cardboard_length', title: '纸板尺寸', sortable: true"></th>
                        <th data-options="field: 'cardboard_length', title: '尺寸类型', sortable: true"></th>
                        <th data-options="field: 'width_line', title: '压线规格', sortable: true"></th>               
                        <th data-options="field: 'line_type', title: '压线类型', sortable: true"></th>  
                        <th data-options="field: 'purchase_number', title: '订单数量', sortable: true"></th>
                        ...
                        <th data-options="field: 'pit_type', title: '采购备注', sortable: true"></th>
