    ...
    <div data-options="region:'center',iconCls:'icon-reload',title:'',split:true,border:false,bodyCls:'border_left_right'">
        ...
        <table data-toggle="topjui-datagrid"
            ...
            <tr>
                ...
                <th data-options="field:'number', title: '配送人名称',sortable:true"></th>
                <th data-options="field:'name', title: '配送人电话',sortable:true"></th>
                <th data-options="field:'name', title: '配送人车牌号',sortable:true"></th>
            </tr>
            </thead>
        </table>
    </div>
