            ...
            <div data-options="region:'center',title:'',fit:false,split:true,border:false,bodyCls:'border_right_bottom'"
                ...
                <table data-toggle="topjui-datagrid"
                    ...
                    <tr>
                        ...
                        <th data-options="field: 'user_account', title: '代号', sortable: true"></th>
                        <th data-options="field: 'user_company', title: '楞型', sortable: true"></th>
                        <th data-options="field: 'user_address', title: '长度压线公式', sortable: true"></th>
                        <th data-options="field: 'user_lock', title: '宽度压线公式', sortable: true"></th>
                    </tr>
                    </thead>
                </table>
            </div>
...
<!-- 表格工具栏开始 -->
	<div id="userDg-toolbar" class="topjui-toolbar"
       ...
       dialog:{
           ...
           height: 300,
           id:'userAddDialog',
           href:_ctx + '/jsp/plate/boxAdd.jsp',
           buttonsGroup:[
