            ...
            <div data-options="region:'center',title:'',fit:false,split:true,border:false,bodyCls:'border_right_bottom'"
                ...
                <table data-toggle="topjui-datagrid"
                    ...
                    <tr>
                        ...
                        <th data-options="field: 'user_account', title: '楞率', sortable: true"></th>
                        <th data-options="field: 'user_company', title: '厚度', sortable: true"></th>
...
<div id="userDg-toolbar" class="topjui-toolbar"
     ...
     <a href="javascript:void(0)"
       ...
       dialog:{
           ...
           height: 250,
           id:'userAddDialog',
           href:_ctx + '/jsp/plate/pitTypeAdd.jsp',
           buttonsGroup:[
