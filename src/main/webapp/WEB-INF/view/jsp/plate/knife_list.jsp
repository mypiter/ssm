            ...
            <div data-options="region:'center',title:'',fit:false,split:true,border:false,bodyCls:'border_right_bottom'"
                ...
                <table data-toggle="topjui-datagrid"
                    ...
                    <tr>
                        ...
                        <th data-options="field: 'user_account', title: '尺寸', sortable: true"></th>
                        <th data-options="field: 'user_account', title: '代号', sortable: true"></th>
                        <th data-options="field: 'user_company', title: '文件', sortable: true"></th>
                        <th data-options="field: 'user_account', title: '图片', sortable: true"></th>
                    </tr>
                    </thead>
                </table>
            </div>
...
<!-- 表格工具栏开始 -->
	<div id="userDg-toolbar" class="topjui-toolbar"
       ...
       dialog:{
           ...
           height: 500,
           id:'userAddDialog',
             href:_ctx + '/jsp/plate/knifeAdd.jsp',
           buttonsGroup:[
