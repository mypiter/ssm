  ...
  <div data-options="region:'center',title:'',fit:false,split:true,border:false,bodyCls:'border_right_bottom'">
                ...
                <table data-toggle="topjui-datagrid"
                       data-options="id:'userDg',
					    ...
					    selectOnCheck:false,
					    checkOnSelect:false,
                       	url:'/KnifeTemplate/KnifeList/',
			            childTabs: [
                            {id:'eastTabs'}
                        ]">
                    <thead>
                     <tr>
                        <th data-options="field: 'knifeTemplateId', title: 'UID', checkbox: true"></th>
                        <th data-options="field: 'knifeTemplateName', title: '刀模名称', sortable: true"></th>
                        <th data-options="field: 'knifePlateNum', title: '刀模编号', sortable: true"></th>
                        <th data-options="field: 'knifePicture', title: '照片', sortable: true"></th>
 					</tr>        
                    </thead>
                </table>
            </div>
...
<!-- 表格工具栏开始 -->
	<div id="userDg-toolbar" class="topjui-toolbar"
       ...
       tab:{
           title:'刀模登记',
            href:'/AdminController/jsp/?url=/raw_material_register/knife_die'
       }">新增</a>
        <a href="javascript:void(0)" data-toggle="topjui-menubutton"
            ...
            tab: {
                title:'编辑刀模',
                href: '/KnifeTemplate/edit/?url=/raw_material_register/knife_die&knifeTemplateId={knifeTemplateId}'
            }">编辑</a>
       <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       ...
       grid: {uncheckedMsg:'请先勾选要删除的数据',param:'knifeTemplateId:knifeTemplateId'}">删除</a>
	   <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
