            ...
            <div data-options="region:'center',title:'',fit:false,split:true,border:false,bodyCls:'border_right_bottom'"
                ...
                <table data-toggle="topjui-datagrid"
                       data-options="id:'userDg',
                        ...
                        fitColumns:true,
                        rownumbers: true,
                        url:'${pageContext.request.contextPath}/json/demo/endOrder.json',
			            childTabs: [
                    ...
                    <tr>
                        ...
                        <th data-options="field: 'completed_num', title: '完成数量', sortable: true"></th>
             
                        <th data-options="field: 'order_time', title: '下单时间', sortable: true"></th>
                        <th data-options="field: 'order_endTime', title: '完成时间', sortable: true"></th>
...
<div id="userDg-toolbar" class="topjui-toolbar"
   ...
   <!--   <a href="javascript:void(0)"
    ...
    <a href="javascript:void(0)"
       ...
       extend: '#userDg-toolbar',
       btnCls:'topjui-btn-normal'">查询</a>
      <!--   <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="method:'',
       extend: '#userDg-toolbar',
       iconCls: 'fa fa-comment',
       btnCls:'topjui-btn-warm'">查看工序信息</a> -->
       <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
