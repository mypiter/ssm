...
<div data-toggle="topjui-layout" data-options="fit:true">
    ...
    <tr>
        ...
        <th data-options="field:'type',title:'物材名称',sortable:true"></th>
         <th data-options="field:'createTime',title:'物材规格',sortable:true"></th>
        <th data-options="field:'code',title:'所属库区',sortable:true"></th>
        <th data-options="field:'number',title:'均价',sortable:true,editor:{type:'textbox',options:{required:true,height:30}}"></th>
