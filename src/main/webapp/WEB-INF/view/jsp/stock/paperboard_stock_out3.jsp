...
<div data-toggle="topjui-layout" data-options="fit:true">
    <div data-options="region:'center',title:'',fit:true,border:false,bodyCls:'border_right_bottom'">
        ...
        <table class="editTable" border="0" style="margin-left: 2px;text-align: left!important;" cellpadding="15px">
            <tr>
                ...
                <td class="label1">选择出库批号（纸板订单号自动生成出库批号并且还未出库的）</td>
                <td>
                   <input type="text" name="user"
                       data-toggle="topjui-combogrid"
                       data-options="required:true,id:'user',
    ...
    <tr>
        ...
        <th data-options="field:'type',title:'库存单号',sortable:true"></th>
        <th data-options="field:'code',title:'材质',sortable:true"></th>
        <th data-options="field:'code',title:'楞型',sortable:true"></th>
        <th data-options="field:'code',title:'纸板尺寸',sortable:true"></th>
        <th data-options="field:'code',title:'尺寸类型',sortable:true"></th>
        <th data-options="field:'code',title:'宽度压线',sortable:true"></th>
        <th data-options="field:'code',title:'压线类型',sortable:true"></th>
        <th data-options="field:'createTime',title:'供应商名称',sortable:true"></th>
        <th data-options="field:'number',title:'库存数量',sortable:true"></th>
        <th data-options="field:'qu',title:'出库数量',sortable:true,editor:{type:'textbox',options:{required:true,height:30}}"></th>
