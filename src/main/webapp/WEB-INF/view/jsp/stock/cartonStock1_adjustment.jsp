...
<div data-toggle="topjui-layout" data-options="fit:true">
    ...
    <tr>
        ...
        <th data-options="field:'createTime',title:'客户名称',sortable:true"></th>
        <th data-options="field:'createTime',title:'业务员',sortable:true"></th>
        <th data-options="field:'createTime',title:'产品名称',sortable:true"></th>
        <th data-options="field:'createTime',title:'订单数量',sortable:true"></th>
        <th data-options="field:'kuqu',title:'库存数量',sortable:true,editor:{type:'textbox',options:{required:true,height:30}}"></th>
        <th data-options="field:'number',title:'单价',sortable:true,editor:{type:'textbox',options:{required:true,height:30}}"></th>
        <th data-options="field:'number',title:'总金额',sortable:true,editor:{type:'textbox',options:{required:true,height:30}}"></th>        
        <th data-options="field:'kfsf',title:'调整类型',sortable:true,editor:{type:'textbox',options:{required:true,height:30}}"></th>
        <th data-options="field:'kfsf',title:'备注',sortable:true,editor:{type:'textbox',options:{required:true,height:30}}"></th>
        <th data-options="field:'createTime',title:'材质',sortable:true"></th>
        <th data-options="field:'createTime',title:'楞型',sortable:true"></th>
        <th data-options="field:'createTime',title:'纸箱尺寸',sortable:true"></th>
    </tr>
    </thead>
</table>
    </div>
