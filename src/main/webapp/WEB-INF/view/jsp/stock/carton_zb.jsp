...
<div data-toggle="topjui-layout" data-options="fit:true">
    <div data-options="region:'center',title:'',fit:true,border:false,bodyCls:'border_right_bottom'">
        <div data-toggle="topjui-tabs" data-options="fit:true,border:false">
            <div title="纸板借调" data-options="iconCls:'fa fa-th'">
    ...
    <tr>
        ...
        <th data-options="field:'number',title:'借调数量',sortable:true,editor:{type:'textbox',options:{required:true,height:30}}"></th>
        ...
        <th data-options="field:'creator',title:'纸板尺寸',sortable:true"></th>
        <th data-options="field:'creator',title:'尺寸类型',sortable:true"></th>
        <th data-options="field:'creator',title:'宽度压线',sortable:true"></th>
        <th data-options="field:'creator',title:'压线类型',sortable:true"></th>
        <th data-options="field:'creator',title:'供应商',sortable:true"></th>
    </tr>
    </thead>
</table>
    </div>
