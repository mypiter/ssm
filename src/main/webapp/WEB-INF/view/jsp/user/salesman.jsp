            ...
            <div data-options="region:'center',title:'',fit:false,split:true,border:false,bodyCls:'border_right_bottom'"
                ...
                <table data-toggle="topjui-datagrid"
                       data-options="id:'userDg',
                        ...
                        fitColumns:true,
                        rownumbers: true,
                        url:'${pageContext.request.contextPath}/jsp/user/json/salesman.json',
			            childTabs: [
                    ...
                    <thead>
                    <tr>
                        <th data-options="field: 'user_id', title: 'UUID', checkbox: true"></th>
                        <th data-options="field: 'user_name', title: '姓名', sortable: true"></th>
                        <th data-options="field: 'user_account', title: '帐号', sortable: true"></th>
                        <th data-options="field: 'user_registerTime', title: '注册时间', sortable: true"></th>
                        <th data-options="field: 'user_qq', title: 'qq', sortable: true"></th>
                        <th data-options="field: 'user_quota', title: '业务员额度', sortable: true"></th>
                        <th data-options="field: 'user_lockTime', title: '授信时间', sortable: true"></th>
                        <th data-options="field: 'user_lock', title: '是否锁单', sortable: true"></th>
                        <th data-options="field: 'level', title: '用户类型', sortable: true"></th>
                    </tr>
                    </thead>
                </table>
            </div>
    ...
    <a href="javascript:void(0)"
       ...
       data-options="method: 'openDialog',
            ...
            dialog: {
                width: 750,
                height: 500,
                href: _ctx + '/jsp/user/userAdd.jsp?transaction_id={uuid}',
                url: _ctx + '/json/demo/userEdit.json?transaction_id={uuid}',
                buttonsGroup: [
                    {
                        text: '更新',
