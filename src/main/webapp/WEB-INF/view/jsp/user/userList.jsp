...
<script>
    ...
    $(function () {
        ...
        $("#productDg").iDatagrid({
            ...
            columns: [[
                {field: 'user_id', title: 'UID', checkbox: true},
                {field: 'user_name', title: '姓名', sortable: true},
                {field: 'user_account', title: '帐号', sortable: true},
                {field: 'user_company', title: '用户公司', sortable: true},
                {field: 'user_address', title: '地址', sortable: true},
                /* {field: 'rate', title: '完成率', sortable: true, formatter: progressFormatter} */
                {field: 'user_registerTime', title: '注册时间', sortable: true},
                {field: 'user_tel', title: '电话', sortable: true},
                {field: 'user_qq', title: 'qq', sortable: true},
                {field: 'user_quota', title: '用户额度', sortable: true},
                {field: 'user_lockTime', title: '授信时间', sortable: true},
                {field: 'user_lock', title: '是否锁单', sortable: true},
