...
<html>
  ...
  <body>
  	...
  	<h3 align="center" style="">客户详情</h3><br>
  			...
  			<table id="tab" border="1px" bordercolor="#000000" cellspacing="0px" >
  				<tr >
  					<td colspan="4"  align="center">
  						...
  						<h4><b>当前为id是<strong class="str1"></strong>的客户详细信息</b></h4>
  					</td>
  					
  				</tr>
  				<tr  >
  					<td style="width:15%" align="center"  ><b>客户联系人</b></td>
  				    <td style="width:18% " align="center"  >      </td>
  				    <td style="width:15%" align="center"  ><b>客户公司</b></td>
  				    <td style="width:18% " align="center"  >      </td>
  				</tr>
  				<tr >
  					<td style="width:15%" align="center"><b>所属业务员</b></td>
  				    <td style="width:18% " align="center"></td>
  				    <td style="width:15%" align="center"><b>电话</b></td>
  				    <td style="width:18% " align="center"></td>
  				...
  				<tr >
  					 <td style="width:15%" align="center"  ><b>客户账期类型</b></td>
  				    <td style="width:18% " align="center"></td>
  					<td style="width:15%" align="center"><b>账期天数 </b></td>
  					<td style="width:18%" align="center"></td>
  					
  				</tr>
  				<tr >
  					 <td style="width:15%" align="center"><b>授信天数</b></td>
  					<td style="width:18%" align="center"></td>
  					<td style="width:15%" align="center"><b>客户额度</b></td>
  				    <td style="width:18% " align="center"></td>

  				</tr>
  				<tr >
  					 <td style="width:15%" align="center"><b>微信</b></td>
  				    <td style="width:18% " align="center"></td>
  				    <td style="width:15%" align="center"><b>QQ</b></td>
  					<td style="width:18%" align="center"></td>
  				</tr>
  				<tr >
  					<td style="width:15%" align="center"><b>送货距离/公里</b></td>
  					<td style="width:18%" align="center"></td>
  				    <td style="width:15%" align="center"><b>是否含付税款</b></td>
  					<td style="width:18%" align="center"></td>
  				    
  					
  				</tr>
  				<tr >
  					<td style="width:15%" align="center"><b>送货单样式</b></td>
  				    <td style="width:18% " align="center"></td>
  					<td style="width:15%" align="center"><b>货款打折</b></td>
  					<td style="width:18%" align="center"></td>
  					
  				</tr>
  				<tr >
  					<td style="width:15%" align="center"><b>地址</b></td>
