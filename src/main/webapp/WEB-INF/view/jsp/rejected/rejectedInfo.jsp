...
<html>
  ...
  <body>
  	...
  	<h3 align="center" style="">退货详情</h3><br>
  			...
  			<table id="tab" border="1px" bordercolor="#000000" cellspacing="0px" >
  				<tr >
  					<td colspan="4"  align="center">
  						...
  						<h4><b>当前为产品名称是....<strong class="str1"></strong>的退货详细信息</b></h4>
  					</td>
  				...
  				<tr >
  					<td style="width:15%" align="center"><b>退货产品名称</b></td>
  				    <td style="width:18% " align="center"></td>
  					<td style="width:15%" align="center"><b>退货数量</b></td>
  				    <td style="width:18% " align="center"></td>
  				...
  				<tr >
  			  	 	<td style="width:15%" align="center"><b>退货时间</b></td>
  				    <td style="width:18% " align="center"></td>
  					<td style="width:15%" align="center"  ><b>退货类型</b></td>
  				    <td style="width:18% " align="center"></td>
  					
  					
  				</tr>
  				<tr >
  					<td style="width:15%" align="center"><b>退赔方式 </b></td>
  					<td style="width:18%" align="center"></td>
  				...
  				<tr >
  					<td style="width:15%" align="center"><b>退赔金额</b></td>
  					<td style="width:18%" align="center"></td>
  					 <td style="width:15%" align="center"><b>退赔时间</b></td>
  					<td style="width:18%" align="center"></td>
  				...
  				<tr>
  					<td style="width:15%" align="center"><b>规格</b></td>
  					<td style="width:18%" align="center"></td>
  				   	<td style="width:15%" align="center"><b></b></td>
  					<td style="width:18%" align="center"></td>
  				</tr>
  				<tr >
  					<td style="width:15%" align="center"><b> 退货原因</b></td>
