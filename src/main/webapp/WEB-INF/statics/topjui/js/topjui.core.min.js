...
function code2Text(a) {
    ...
    return $(this).each(function(c) {
        var d = {
            ...
            h = g.textField,
            i = g.valueField;
        if ("object" == typeof g.data) for (var j = g.data,
                                                c = 0; c < j.length; c++) j[c][i] == a && (b = j[c][h]);
        else $.ajax({
...
function openDialogAndloadDataByParentGrid(a) {
    ...
    if (!a.dialog.beforeOpenCheckUrl || beforeOpenCheck(replaceUrlParamValueByBrace(a.dialog.beforeOpenCheckUrl, d))) {
        ...
        var e = $("#" + a.dialog.id),
            f = topJUI.config.appendRefererParam ? appendRefererParam(a.dialog.href) : a.dialog.href,
            g = f;
...
function deleteHandler(a) {
    var b = $.data(a, "menubutton").options,
        c = {};
    b = $.extend(c, b),
    topJUI.config.appendRefererParam && (b.url = appendRefererParam(b.url));
...
function importHandler(a) {
    if ("object" == typeof a.grid) {
        ...
        b += "<tr>",
            b += '<td width="450"><input type="text" class="importFilePath" name="filePath"></td>',
            b += '<td width="100"><button type="button" class="layui-btn layui-btn-sm" id="importUpBtn"><i class="layui-icon"></i>上传文件</button></td>',
            b += "</td>",
            b += "</tr>",
            b += "</table>";
        var c = {
        ...
        d += '<div id="importDialog-buttons" style="display:none">',
            d += '<a href="#" id="submitImportForm" data-toggle="topjui-linkbutton" data-options="iconCls:\'fa fa-check-circle\'">开始导入</a>',
            d += '<a href="#" id="closeImportDialog" data-toggle="topjui-linkbutton" data-options="btnCls:\'topjui-btn-red\'">关闭</a>',
            d += "</div>",
            $("body").append(d);
        var e = $("#" + a.dialog.id);
        e.dialog(a.dialog);
                ...
                function() {
                    ...
                    b.render({
                        ...
                        before: function(a) {
                            ...
                            a.statusCode == topJUI.config.statusCode.success ? f.textbox("setValue", a.filePath) : layer.msg(a.msg, {
                                icon: 5
                            }),
            ...
            $("#submitImportForm").linkbutton({
                ...
                onClick: function() {
                    var b = $("#" + a.dialog.id).serialize(),
                        ...
                        d = {};
                    d.ajaxData = b + "&colName=" + c.colName + "&fieldName=" + c.fieldName,
                        d.url = a.url;
                    var e = doAjax(d);
                    e.statusCode == topJUI.config.statusCode.success && ($("#" + a.dialog.id).dialog("close"), refreshGrid(a.grid.type, a.grid.id)),
                        showMessage(e)
                }
            }),
...
function uploadHandler(a) {
    ...
    if ("object" == typeof b.grid) {
        ...
        f += '<div id="' + d + '-buttons" style="display:none">',
            f += '<a href="#" id="' + d + '-close">关闭</a>',
            f += "</div>",
            $("body").append(f);
        var g = {
            dialog: {
                    ...
                    choose: function(a) {
                        ...
                        if (c.statusCode == topJUI.config.statusCode.success) {
                            for (var f = upfileGrid.datagrid("getRows"), g = 0; g < f.length; g++) upfileGrid.datagrid("updateRow", {
                                ...
                                delete i[f[g].uuid];
                            return j++,
                                void(j == f.length && (j = 0, a("#" + b.grid.id)[b.grid.type]("reload")))
                        }
                        this.error(d, e)
                    },
                    error: function(a, b) {
...
function exportHandler(a) {
    ...
    if ("object" == typeof a.grid) if (d = a.grid.id, "datagrid" == a.grid.type) {
        e = $("#" + d).datagrid("getColumnFields", !0),
            f = $("#" + d).datagrid("getColumnFields"),
            g = e.concat(f);
        for (var k = 0; k < g.length; k++) h = $("#" + d).datagrid("getColumnOption", g[k]),
            i.push(h.title),
            1 == h.hidden || 1 == h.checkbox ? j.push(!0) : j.push(!1)
    } else if ("treegrid" == a.grid.type) {
        e = $("#" + d).treegrid("getColumnFields", !0),
            f = $("#" + d).treegrid("getColumnFields"),
            g = e.concat(f);
        for (var l = 0; l < g.length; l++) h = $("#" + d).treegrid("getColumnOption", g[l]),
            i.push(h.title),
            1 == h.hidden || 1 == h.checkbox ? j.push(!0) : j.push(!1)
    }
...
function menuHandler(a) {
    ...
    var b = $(a.extend),
        ...
        d = $.extend(!0, c, a);
    "openDialog" == d.method && openDialog(d),
    "doAjax" == d.method && doAjaxHandler(d),
    "import" == d.method && importHandler(d),
    "export" == d.method && exportHandler(d),
    "openTab" == d.method && addParentTab(d),
    "openWindow" == d.method && openWindow(d),
    "request" == d.method && requestHandler(d)
}
var defaultConfig = {
    version: "v3.0.0",
    config: {
        ...
        a.fn.linkbutton = function(d, e) {
            return "string" == typeof d ? a.fn.linkbutton.methods[d](this, e) : (d = d || {},
                this.each(function() {
                    ...
                    }), a(this)._propAttr("disabled", !1), a(this).bind("_resize",
                        function(c, d) {
                    ...
                    function e(c, d) {
                        for (var h = [], j = 0; j < d.length; j++) {
                            ...
                            "open" != k.state && "closed" != k.state && (k.state = "open"),
                                ...
                                h.push("<li>"),
                                h.push('<div id="' + k.domId + '" class="tree-node' + (k.nodeCls ? " " + k.nodeCls: "") + '">');
            ...
            function c(c) {
                ...
                switch (e.position) {
                    case "right":
                        ...
                        "middle" == e.valign && (g -= (f._outerHeight() - j._outerHeight()) / 2);
                        break;
                    case "left":
    ...
    function($) {
        ...
        function setSize(a, b) {
            ...
            if (!d.hasResized || j != l || k != m) {
                if (d.hasResized = !0, i || f._outerWidth(e.width()), g._outerWidth(e.width()), isNaN(parseInt(d.height))) {
                    ...
                    g._size("minHeight", n ? n - p: ""),
                        g._size("maxHeight", o ? o - p: "")
                } else if (i) {
                    ...
                    var s = e.height();
                    f._outerWidth(q)._outerHeight(s),
                        r._outerWidth(f.height()),
                        g._outerWidth(e.width() - q - h._outerWidth())._outerHeight(s),
                        h._outerHeight(s),
                        g.css({
                            left: "",
                            right: ""
                        }).css(d.halign, f.position()[d.halign] + q + "px"),
                        d.panelCssWidth = e.css("width"),
                    d.collapsed && e._outerWidth(q + h._outerWidth())
        ...
        function openPanel(a, b) {
            function c() {
                ...
                b.length && (e.maximized = !0),
                    e.onOpen.call(a),
                1 == e.maximized && (e.maximized = !1, maximizePanel(a)),
                1 == e.collapsed && (e.collapsed = !1, collapsePanel(a)),
                e.collapsed || !e.href || d.isLoaded && e.cache || (loadData(a), doLayout(a), e.doneLayout = !0),
                e.doneLayout || (e.doneLayout = !0, doLayout(a))
            }
            var d = $.data(a, "panel"),
                e = d.options,
                f = d.panel;
            if (1 == b || 0 != e.onBeforeOpen.call(a)) if (f.stop(!0, !0), $.isFunction(e.openAnimation)) e.openAnimation.call(a, c);
                ...
                c.panel($.extend({},
                    b, {
                        ...
                        onOpen: function() {
                            ...
                            d.selectHis.push(e),
                                d.options.onSelect.call(a, c.title, e)
                        },
                        onBeforeClose: function() {
                    ...
                    if (f.html(d.title), g.attr("class", "tabs-icon"), e.find("a.tabs-close").remove(), d.closable ? (f.addClass("tabs-closable"), $('<a href="javascript:;" class="tabs-close"></a>').appendTo(e)) : f.removeClass("tabs-closable"), d.iconCls ? (f.addClass("tabs-with-icon"), g.addClass(d.iconCls)) : f.removeClass("tabs-with-icon"), d.tools) {
                        ...
                        if ($.isArray(d.tools)) {
                            ...
                            for (var i = 0; i < d.tools.length; i++) {
                                ...
                                j.addClass(d.tools[i].iconCls),
                                d.tools[i].handler && j.bind("click", {
                        ...
                        d.closable ? (k += 8, h.css("right", "")) : (k -= 3, h.css("right", "5px")),
                            f.css("padding-right", k + "px")
                    } else e.find("span.tabs-p-tool").remove(),
                        f.css("padding-right", "")
                }
            }
            d.disabled ? d.tab.addClass("tabs-disabled") : d.tab.removeClass("tabs-disabled"),
                setSize(a),
                $.data(a, "tabs").options.onUpdate.call(a, d.title, getTabIndex(a, c))
        }
        function closeTab(a, b) {
            ...
            if (exists(a, b)) {
                ...
                if (0 != d.onBeforeClose.call(a, g, h)) {
                    ...
                    c.selectHis = i;
                    var l = $(a).tabs("getSelected"); ! l && i.length && (h = c.selectHis.pop(), $(a).tabs("select", h))
                }
            }
        }
                        ...
                        function() {
                            if ("dock" == m.expandMode) g(b, c);
                                ...
                                l.panel("resize", d.collapse),
                                    l.panel("panel").unbind(".layout").bind("mouseleave.layout", {
                                            region: c
                                        },
                                        function(c) {
                                            a(this).stop(!0, !0),
        ...
        $(function() {
            ...
            $.fn.menu.methods = {
                ...
                findItem: function(a, b) {
                    return "string" == typeof b ? findItem(a[0],
                        function(a) {
    ...
    function(a) {
        ...
        function c(b, c) {
            ...
            c && a.extend(d, {
                ...
                a(b)._size(d),
                a(b).find(".accordion").accordion("resize")
        }
        function d(b, c, d) {
            ...
            f.tree({
                ...
                f.unbind(".sidemenu").bind("mouseleave.sidemenu",
                    function() {
        ...
        function e(b, c, e) {
            ...
            a(c).tooltip({
                ...
                onShow: function() {
                    ...
                    c.children(".tooltip-content").addClass("sidemenu"),
                        c.find(".accordion").accordion("resize"),
                        c.add(c.find("ul.tree")).unbind(".sidemenu").bind("mouseover.sidemenu",
                            function() {
                                b.tooltip("show")
        ...
        function i(b) {
            ...
            if (a(b).empty(), c.data) {
                a.easyui.forEach(c.data, !0,
                    function(a) {
                        a.id || (a.id = "_easyui_sidemenu_" + l++),
                        a.iconCls || (a.iconCls = "sidemenu-default-icon"),
                        a.children && (a.nodeCls = "tree-node-nonleaf", a.state || (a.state = "closed"), "open" == a.state ? a.nodeCls = "tree-node-nonleaf": a.nodeCls = "tree-node-nonleaf tree-node-nonleaf-collapsed")
                    });
        ...
        function j(b, c) {
            ...
            if (e.accordion("options").animate = !1, d.collapsed) {
                ...
                for (var g = 0; g < f.length; g++) {
                    ...
                    i.find(".panel-title").html(""),
                        i.find(".panel-tool").hide()
                }
            } else {
                ...
                for (var g = 0; g < f.length; g++) {
                    ...
                    var i = h.panel("header");
                    i.find(".panel-title").html(h.panel("options").title),
                        i.find(".panel-tool").show()
                }
            }
            ...
            return d = d || {},
                this.each(function() {
                    ...
                    e ? a.extend(e.options, d) : (e = a.data(this, "sidemenu", {
                        options: a.extend({},
                            a.fn.sidemenu.defaults, a.fn.sidemenu.parseOptions(this), d)
                    }), b(this)),
                        c(this),
                        i(this),
                        j(this, e.options.collapsed)
                })
        },
    ...
    function(a) {
        function b(b) {
            ...
            var e = d.attr("name");
            return e && (d.removeAttr("name").attr("radiobuttonName", e), c.find(".radiobutton-value").attr("name", e)),
                c
        }
        function c(b) {
            var c = a.data(b, "radiobutton"),
                d = c.options,
                e = c.radiobutton,
                i = "_easyui_radiobutton_" + ++h;
            e.find(".radiobutton-value").attr("id", i),
                d.label ? "object" == typeof d.label ? (c.label = a(d.label), c.label.attr("for", i)) : (a(c.label).remove(), c.label = a('<label class="textbox-label"></label>').html(d.label), c.label.css("textAlign", d.labelAlign).attr("for", i), "after" == d.labelPosition ? c.label.insertAfter(e) : c.label.insertBefore(b), c.label.removeClass("textbox-label-left textbox-label-right textbox-label-top"), c.label.addClass("textbox-label-" + d.labelPosition)) : a(c.label).remove(),
                a(b).radiobutton("setValue", d.value),
                f(b, d.checked),
                g(b, d.disabled)
        }
        function d(b) {
            var c = a.data(b, "radiobutton"),
                d = c.options,
                e = c.radiobutton;
            e.unbind(".radiobutton").bind("click.radiobutton",
                function() {
                    d.disabled || f(b, !0)
                })
        }
        function e(b) {
            var c = a.data(b, "radiobutton"),
                ...
                e = c.radiobutton;
            e._size(d, e.parent()),
            d.label && d.labelPosition && ("top" == d.labelPosition ? c.label._size({
                    width: d.labelWidth
                },
                e) : (c.label._size({
                    width: d.labelWidth,
        ...
        function f(b, c) {
            function d(b, c) {
                ...
                e.find(".radiobutton-inner").css("display", c ? "": "none"),
                    e.find(".radiobutton-value")._propAttr("checked", c),
                d.checked != c && (d.checked = c, d.onChange.call(a(b)[0], c))
            }
            if (c) {
        ...
        function g(b, c) {
            ...
            e.disabled = c,
                c ? (a(b).add(g)._propAttr("disabled", !0), f.addClass("radiobutton-disabled")) : (a(b).add(g)._propAttr("disabled", !1), f.removeClass("radiobutton-disabled"))
        }
        var h = 1;
        a.fn.radiobutton = function(f, g) {
            return "string" == typeof f ? a.fn.radiobutton.methods[f](this, g) : (f = f || {},
                this.each(function() {
                    var g = a.data(this, "radiobutton");
                    g ? a.extend(g.options, f) : g = a.data(this, "radiobutton", {
                        options: a.extend({},
                            a.fn.radiobutton.defaults, a.fn.radiobutton.parseOptions(this), f),
                        radiobutton: b(this)
                    }),
                        g.options.originalChecked = g.options.checked,
                        c(this),
                        d(this),
                        e(this)
                }))
            ...
            a.fn.radiobutton.methods = {
                ...
                setValue: function(b, c) {
                    return b.each(function() {
                        a(this).val(c),
                            a.data(this, "radiobutton").radiobutton.find(".radiobutton-value").val(c)
                    })
                },
                enable: function(a) {
                    return a.each(function() {
            ...
            a.fn.radiobutton.parseOptions = function(b) {
                var c = a(b);
                return a.extend({},
                    a.parser.parseOptions(b, ["label", "labelPosition", "labelAlign", {
                        labelWidth: "number"
                    }]), {
                        value: c.val() || void 0,
                        checked: !!c.attr("checked") || void 0,
    ...
    function(a) {
        function b(b) {
            ...
            var e = d.attr("name");
            return e && (d.removeAttr("name").attr("checkboxName", e), c.find(".checkbox-value").attr("name", e)),
                c
        }
        function c(b) {
            var c = a.data(b, "checkbox"),
                d = c.options,
                e = c.checkbox,
                i = "_easyui_checkbox_" + ++h;
            e.find(".checkbox-value").attr("id", i),
                d.label ? "object" == typeof d.label ? (c.label = a(d.label), c.label.attr("for", i)) : (a(c.label).remove(), c.label = a('<label class="textbox-label"></label>').html(d.label), c.label.css("textAlign", d.labelAlign).attr("for", i), "after" == d.labelPosition ? c.label.insertAfter(e) : c.label.insertBefore(b), c.label.removeClass("textbox-label-left textbox-label-right textbox-label-top"), c.label.addClass("textbox-label-" + d.labelPosition)) : a(c.label).remove(),
                a(b).checkbox("setValue", d.value),
                f(b, d.checked),
                g(b, d.disabled)
        }
        function d(b) {
            var c = a.data(b, "checkbox"),
                d = c.options,
                e = c.checkbox;
            e.unbind(".checkbox").bind("click.checkbox",
                function() {
        ...
        function f(b, c) {
            ...
            c ? g.addClass("checkbox-checked") : g.removeClass("checkbox-checked"),
            e.checked != c && (e.checked = c, e.onChange.call(b, c))
        }
        function g(b, c) {
            var d = a.data(b, "checkbox"),
                e = d.options,
            ...
            e.disabled = c,
                c ? (a(b).add(g)._propAttr("disabled", !0), f.addClass("checkbox-disabled")) : (a(b).add(g)._propAttr("disabled", !1), f.removeClass("checkbox-disabled"))
        }
        var h = 1;
        a.fn.checkbox = function(f, g) {
            return "string" == typeof f ? a.fn.checkbox.methods[f](this, g) : (f = f || {},
                this.each(function() {
                    var g = a.data(this, "checkbox");
                    g ? a.extend(g.options, f) : g = a.data(this, "checkbox", {
                        options: a.extend({},
                            a.fn.checkbox.defaults, a.fn.checkbox.parseOptions(this), f),
                        checkbox: b(this)
                    }),
                        g.options.originalChecked = g.options.checked,
                        c(this),
            ...
            a.fn.checkbox.methods = {
                ...
                setValue: function(b, c) {
                    return b.each(function() {
                        a(this).val(c),
                            a.data(this, "checkbox").checkbox.find(".checkbox-value").val(c)
                    })
                },
                enable: function(a) {
                    return a.each(function() {
    ...
    function($) {
        ...
        function setDisabled(a, b) {
            ...
            void 0 != b && (c.disabled = b),
                c.disabled ? $(a).addClass("validatebox-disabled")._propAttr("disabled", !0) : $(a).removeClass("validatebox-disabled")._propAttr("disabled", !1)
        }
        function setReadonly(a, b) {
            var c = $.data(a, "validatebox").options;
            c.readonly = void 0 == b || b,
                c.readonly || !c.editable ? ($(a).triggerHandler("blur.validatebox"), $(a).addClass("validatebox-readonly")._propAttr("readonly", !0)) : $(a).removeClass("validatebox-readonly")._propAttr("readonly", !1)
        }
    ...
    function(a) {
            ...
            if (g.attr("placeholder", d.prompt), g.unbind(".textbox"), a(c.label).unbind(".textbox"), !d.disabled && !d.readonly) {
                c.label && a(c.label).bind("click.textbox",
                    ...
                    g.bind("blur.textbox",
                        ...
                        function(b) {
                            d.hasFocusMe = !0,
                            f.hasClass("textbox-focused") || (a(this).val() != d.value && a(this).val(d.value), a(this).removeClass("textbox-prompt"), f.addClass("textbox-focused"), f.closest(".form-field").addClass("form-field-focused"))
                        });
        ...
        function h(b, c) {
            ...
            e.disabled = c,
                e.disabled ? (g.blur(), g.validatebox("disable"), f.addClass("textbox-disabled"), h._propAttr("disabled", !0), a(d.label).addClass("textbox-label-disabled")) : (g.validatebox("enable"), f.removeClass("textbox-disabled"), h._propAttr("disabled", !1), a(d.label).removeClass("textbox-label-disabled"))
        }
        function i(b, c) {
            var d = a.data(b, "textbox"),
                e = d.options,
                ...
                setText: function(b, c) {
                    return b.each(function() {
                        ...
                        d.is(":focus") || (c ? d.removeClass("textbox-prompt") : d.val(b.prompt).addClass("textbox-prompt")),
                            b.value ? a(this).closest(".form-field").removeClass("form-field-empty") : a(this).closest(".form-field").addClass("form-field-empty"),
    ...
    function(a) {
        function b(b) {
            var c = a(b).data("maskedbox"),
                d = c.options;
            a(b).textbox(d),
                a(b).maskedbox("initValue", d.value)
        }
        function c(b, c) {
            ...
            if (j != -1) {
                ...
                if (l.test(e)) {
                    var m = c(b).split(""),
                        ...
                        o = k - g(b, k);
                    m.splice(n, o - n, e),
                        a(b).maskedbox("setValue", d(b, m.join(""))),
                        j = h(b, ++j),
                        a(b).maskedbox("setSelectionRange", {
                            start: j,
                            end: j
                        })
                }
        ...
        function f(b, e) {
            ...
            a(b).maskedbox("setValue", d(b, f.join(""))),
                a(b).maskedbox("setSelectionRange", {
                    start: k,
                    end: k
                })
        ...
        function h(b, c) {
            for (var d = a(b).maskedbox("options"), e = d.mask[c], f = d.masks[e]; c < d.mask.length && !f;) c++,
                e = d.mask[c],
                f = d.masks[e];
            return c
        }
        function i(b, c) {
            for (var d = a(b).maskedbox("options"), e = d.mask[--c], f = d.masks[e]; c >= 0 && !f;) c--,
                e = d.mask[c],
                f = d.masks[e];
            return c < 0 ? 0 : c
        }
        function j(b) {
            if (!b.metaKey && !b.ctrlKey) {
                ...
                return b.keyCode >= 65 && b.keyCode <= 90 && !b.shiftKey ? g = g.toLowerCase() : 189 == b.keyCode ? g = "-": 187 == b.keyCode ? g = "+": 190 == b.keyCode && (g = "."),
                    8 == b.keyCode ? f(c, !0) : 46 == b.keyCode ? f(c, !1) : e(c, g),
                    !1
            }
        }
        a.extend(a.fn.textbox.methods, {
                ...
                return c = c || {},
                    this.each(function() {
                        ...
                        d ? a.extend(d.options, c) : a.data(this, "maskedbox", {
                            options: a.extend({},
                                a.fn.maskedbox.defaults, a.fn.maskedbox.parseOptions(this), c)
                        }),
                            b(this)
                    })
            },
            a.fn.maskedbox.methods = {
                ...
                initValue: function(b, e) {
                    return b.each(function() {
                        e = d(this, c(this, e)),
                            a(this).textbox("initValue", e)
                    })
                },
                setValue: function(b, e) {
                    return b.each(function() {
                        e = d(this, c(this, e)),
                            a(this).textbox("setValue", e)
                    })
                }
            },
            a.fn.maskedbox.parseOptions = function(b) {
                a(b);
                return a.extend({},
                    a.fn.textbox.parseOptions(b), a.parser.parseOptions(b, ["mask", "promptChar"]), {})
            },
            a.fn.maskedbox.defaults = a.extend({},
                a.fn.textbox.defaults, {
                    mask: "",
                    promptChar: "_",
                    masks: {
                ...
                selectName: function(a, b) {
                    return a.each(function() {
                        ...
                        a && a.children("div.menu-item").each(function() {
                            ...
                            if (c.name == b) return $(this).trigger("click"),
                                !1
                        })
                    })
                },
    ...
    function(a) {
        function b(b, e) {
            ...
            if (0 != f.onSubmit.call(b, g)) {
                ...
                f.dirty && i._propAttr("disabled", !1)
            }
        }
        function c(b, c) {
            function d(c) {
        ...
        function e(b, c) {
            ...
            function e(c, d) {
                for (var e = ["switchbutton", "radiobutton", "checkbox"], g = 0; g < e.length; g++) {
                    var h = e[g],
                        i = a(b).find("[" + h + 'Name="' + c + '"]');
                    if (i.length) return i[h]("uncheck"),
                        i.each(function() {
        ...
        function fixRowHeight(a, b, c) {
            ...
            if (setBodySize(a), "auto" == f.height) {
                var l = g.body1.parent(),
                    ...
                    n = e(m),
                    o = n.height;
                n.width > m.width() && (o += 18),
                    o -= parseInt(m.css("marginTop")) || 0,
                    l.height(o),
                    m.height(o),
                        ...
                        function b(b) {
                            ...
                            if (c != -1) if (b.isNewRecord) d.datagrid("cancelEdit", c);
                                ...
                                var f = b[e.idField || "id"],
                                    g = {};
                                g[e.idField || "id"] = f,
                                    e.poster.call(d[0], e.destroyUrl, g,
                                        function(c) {
            ...
            a.fn.datagrid.defaults.view, {
                ...
                renderGroup: function(b, c, d, e) {
                    function f(a, b) {
                        var c = "",
                            d = "";
                        return "string" == typeof a ? d = a: a && (c = a.class || "", d = a.style || ""),
                        'class="' + b + (c ? " " + c: "") + '" style="' + d + '"'
                    }
                    ...
                    k.push("<div group-index=" + c + " " + m + ">"),
                    (e && (h.rownumbers || h.frozenColumns.length) || !e && !h.rownumbers && !h.frozenColumns.length) && (k.push('<span class="datagrid-group-expander">'), k.push('<span class="datagrid-row-expander datagrid-row-collapse">&nbsp;</span>'), k.push("</span>")),
                    (e && j || !e) && (k.push('<span class="datagrid-group-title">'), k.push(h.groupFormatter.call(b, d.value, d.rows)), k.push("</span>")),
                        k.push("</div>"),
                        k.push('<table class="datagrid-btable" cellspacing="0" cellpadding="0" border="0"><tbody>');
                    for (var n = d.startIndex,
                             o = 0; o < d.rows.length; o++) {
                        ...
                        k.push('<tr id="' + t + '" datagrid-row-index="' + n + '" ' + r + " " + s + ">"),
                            k.push(this.renderRow.call(this, b, i, e, n, d.rows[o])),
                            k.push("</tr>"),
                            n++
                    }
                ...
                onAfterRender: function(b) {
                    ...
                    var c = this,
                        d = a.data(b, "datagrid"),
                        e = d.options;
                    d.onResizeColumn || (d.onResizeColumn = e.onResizeColumn),
                    d.onResize || (d.onResize = e.onResize),
                        e.onResizeColumn = function(a, e) {
                            c.resizeGroup(b),
                                d.onResizeColumn.call(b, a, e)
                        },
                        e.onResize = function(e, f) {
                            c.resizeGroup(b),
                                d.onResize.call(a(b).datagrid("getPanel")[0], e, f)
                        },
                        c.resizeGroup(b)
                }
            });
        a.extend(a.fn.datagrid.methods, {
            ...
            expandGroup: function(b, c) {
                return b.each(function() {
                    ...
                    f.hasClass("datagrid-row-expand") && (f.removeClass("datagrid-row-expand").addClass("datagrid-row-collapse"), e.next("table").show()),
                        a(this).datagrid("fixRowHeight"),
                    b.onExpandGroup && b.onExpandGroup.call(this, c)
                })
            },
            collapseGroup: function(b, c) {
                return b.each(function() {
                    var b = a(this).datagrid("options"),
                        ...
                        e = d.find(void 0 != c ? 'div.datagrid-group[group-index="' + c + '"]': "div.datagrid-group"),
                        f = e.find("span.datagrid-row-expander");
                    f.hasClass("datagrid-row-collapse") && (f.removeClass("datagrid-row-collapse").addClass("datagrid-row-expand"), e.next("table").hide()),
                        a(this).datagrid("fixRowHeight"),
                    b.onCollapseGroup && b.onCollapseGroup.call(this, c)
                })
            },
    ...
    function(a) {
        ...
        function p(b) {
            var c = a.data(b, "combo").options,
                d = c.onChange;
            c.onChange = function() {},
                c.multiple ? m(b, c.value ? c.value: []) : o(b, c.value),
                c.onChange = d
        }
        a(function() {
    ...
    function(a) {
        ...
        function g(b, c, d) {
            ...
            if (d || a(b).combo("setText", k.join(f.separator)), f.showItemIcon) {
                ...
                q.removeClass("textbox-bgicon " + f.textboxIconCls),
                i && i.iconCls && (q.addClass("textbox-bgicon " + i.iconCls), f.textboxIconCls = i.iconCls)
            }
            a(b).combo("setValues", j),
                g.triggerHandler("scroll")
        }
        function h(b, c, d) {
    ...
    function(a) {
        ...
        function e(b, c) {
            ...
            if (h = a.grep(h,
                function(b) {
                    return "" != a.trim(b)
                }), g.treegrid("clearSelections").treegrid("clearChecked").treegrid("highlightRow", -1), "remote" == f.mode) d(h),
        ...
        function f(b) {
            ...
            var h = [];
            if (d.multiple) a.map(e.treegrid("getCheckedNodes"),
                function(a) {
                    h.push(a[d.idField])
                });
            else {
            ...
            a.map(d.unselectedValues,
                ...
                a(b).combotreegrid("setValues", h),
            d.multiple || a(b).combotreegrid("hidePanel")
        }
    ...
    function($) {
        ...
        function buildSlider(a) {
            ...
            var d = $.data(a, "slider"),
                e = d.options,
                f = d.slider;
            f.removeClass("slider-h slider-v slider-disabled"),
                f.addClass("h" == e.mode ? "slider-h": "slider-v"),
                f.addClass(e.disabled ? "slider-disabled": "");
            var g = f.find(".slider-inner");
            g.html('<a href="javascript:;" class="slider-handle"></a><span class="slider-tip"></span>'),
            e.range && g.append('<a href="javascript:;" class="slider-handle"></a><span class="slider-tip"></span>'),
                f.find("a.slider-handle").draggable({
                    axis: e.mode,
                    cursor: "pointer",
                    disabled: e.disabled,
                    onDrag: function(a) {
                        var b = a.data.left,
                            d = f.width();
                        return "h" != e.mode && (b = a.data.top, d = f.height()),
                        !(b < 0 || b > d) && (c(b, this), !1)
                    },
                    onStartDrag: function() {
                        d.isDragging = !0,
                            e.onSlideStart.call(a, e.value)
                    },
                    onStopDrag: function(b) {
                        c("h" == e.mode ? b.data.left: b.data.top, this),
                            e.onSlideEnd.call(a, e.value),
                            e.onComplete.call(a, e.value),
                            d.isDragging = !1
                    }
                }),
                f.find("div.slider-inner").unbind(".slider").bind("mousedown.slider",
                    function(b) {
                        if (!d.isDragging && !e.disabled) {
                            var f = $(this).offset();
                            c("h" == e.mode ? b.pageX - f.left: b.pageY - f.top),
                                e.onComplete.call(a, e.value)
                        }
                    })
        }
...
$.getUrlParam = function(a) {
    ...
    function(a) {
        a.fn.iCheckbox = function(b, c) {
            ...
            this.each(function() {
                b = a.fn.iCheckbox.parseOptions(this, b),
                    a(this).checkbox(b)
            })
        },
            a.fn.iCheckbox.methods = {},
            a.fn.iCheckbox.parseOptions = function(b, c) {
                var d = a.extend({},
                    a.fn.checkbox.parseOptions(b), a.fn.iCheckbox.defaults, a.parser.parseOptions(b, ["id", "value"]), c);
                return setId(b, d)
            },
            ...
            a.fn.iCombogrid.defaults = {
                ...
                onChange: function(b, c) {
                    ...
                    if (d.autocomplete && (e.combogrid("grid").datagrid("load", {
                        ...
                        for (var f = {},
                                 g = d.param.split(","), h = 0; h < g.length; h++) if (g[h].indexOf(":") == -1) f[g[h]] = "";
                        else {
                            var i = g[h].split(":");
                            f[i[1]] = ""
                        }
...
var openDialog = function(a) {
        ...
        if ("object" == typeof c) openDialogAndloadDataByParentGrid(a);
            ...
            if (topJUI.config.appendRefererParam && (a.dialog.href = appendRefererParam(a.dialog.href)), a.dialog.href.indexOf("{") != -1) {
                ...
                b.href = replaceUrlParamValueByBrace(a.dialog.href, e[0]),
                    $("#" + b.id).iDialog("openDialog", b),
                    a.dialog.href = f
...
$.fn.serializeObject = function() {
        ...
        a.fn.datagrid.defaults.onHeaderContextMenu = b,
            ...
            a.fn.iDatagrid.methods = {
                ...
                singleSelectedAjax: function(b, c) {
                    ...
                    return null == d ? void unselectedAlert(c) : (c.url = replaceUrlParamValueByBrace(c.url, d), void a.messager.confirm(topJUI.language.message.title.confirmTips, c.confirmMsg,
                        function(a) {
                            if (a) {
                                var b = doAjax(c);
                                b.statusCode == topJUI.config.statusCode.success && (refreshGrid(c.grid.type, c.grid.id), c.reload && refreshGrids(c.reload)),
                                    showMessage(b)
                            }
                        }))
                },
                    ...
                    return 0 == d.length ? void unselectedAlert(c) : void a.messager.confirm(topJUI.language.message.title.confirmTips, c.confirmMsg,
                        function(a) {
                            if (a) {
                                ...
                                var f = doAjax(c);
                                f.statusCode == topJUI.config.statusCode.success && (refreshGrid(c.grid.type, c.grid.id), c.reload && refreshGrids(c.reload)),
                                    showMessage(f)
                            }
                        })
                },
                multiCheckedAjax: function(b, c) {
                    ...
                    return 0 == e.length ? void uncheckedAlert(c) : void a.messager.confirm(topJUI.language.message.title.confirmTips, c.confirmMsg,
                        function(b) {
                            if (b) {
                                void 0 == c.grid.param && (c.grid.param = topJUI.config.pkName + ":" + topJUI.config.pkName),
                                    c.ajaxData = convertParamObj2Serialize(param2JsonObj(c.grid.param), e);
                                var f = doAjax(c);
                                if (f.statusCode == topJUI.config.statusCode.success) {
                                    ...
                                    } ! c.grid.updateRow && c.grid.reload && refreshGrid(c.grid.type, c.grid.id),
                                    c.reload && refreshGrids(c.reload)
                                }
                                showMessage(f)
                            }
                        })
            ...
            a.fn.iDatagrid.defaults = {
                ...
                loadFilter: function(a) {
                    var b = {};
                    return b.total = a[topJUI.config.datagrid.total] ? a[topJUI.config.datagrid.total] : a.length,
                        b.rows = a[topJUI.config.datagrid.rows] ? a[topJUI.config.datagrid.rows] : a.rows,
                            ...
                            function(b) {
                                setTimeout(function() {
                                        ...
                                        if ("panel" == f[b].type) {
                                            ...
                                            c[f[b].type]("options").queryParams = a.extend({},
                                                g, e),
                                                c[f[b].type]("load")
                                        }
                                    },
    ...
    function(a) {
        a.fn.iDatalist = function(b, c) {
            ...
            this.each(function() {
                b = a.fn.iDatalist.parseOptions(this, b),
                    a(this).datalist(b)
            })
        },
            a.fn.iDatalist.methods = {},
            a.fn.iDatalist.parseOptions = function(b, c) {
                var d = a.extend({},
                    a.fn.datalist.parseOptions(b), a.fn.iDatalist.defaults, a.parser.parseOptions(b, ["id", "value"]), c);
                return setId(b, d)
            },
    ...
    function(a) {
        ...
        a.fn.iDialog = function(b, c) {
            ...
            this.each(function() {
                ...
                topJUI.config.appendRefererParam && b.href && (b.href = appendRefererParam(b.href)),
                topJUI.config.appendRefererParam && b.url && (b.url = appendRefererParam(b.url)),
    ...
    function(a) {
        a.fn.iEdatagrid = function(b, c) {
            ...
            this.each(function() {
                ...
                b.initCreate && (topJUI.config.appendRefererParam && (b.url = appendRefererParam(b.url)), a(this).edatagrid(b))
            })
        },
                ...
                onClick: function() {
                    ...
                    if ("object" == typeof b.form) {
                        ...
                        "submit" == c.method ? a("#" + c.id).form("submit", {
                            ...
                            success: function(c) {
                                 //console.log(c);
                                if(c.indexOf("statusCode\":\"200")!=-1) {
                                    $.iMessager.alert('操作提示', '操作成功！', 'question', function (r) {
                                        location.reload();
                                    });
                                }else if(c.indexOf("statusCode\":\"250")!=-1){
                                    //$.iMessager.alert('操作提示','操作成功！','question',function(r){
                                    //location.reload();
                                    //  });
                                     $.iMessager.confirm('操作提示','操作成功！是否跳转到送货单页面？',function(r){
                                         if (r){
                                             var strs= new Array();
                                             var str=c.message;
                                             strs=str.split("|");
                                             ...
                                             var co=strs[2];
                                             location.reload();
                                             window.open("/AdminController/jsp/?url=baobiao/productionReport&deliveryNumber="+s+"&deliveryStyle="+t+"&coid="+co)
                                        }else{
                                             location.reload();
                                        }
                                     });
                                }else if(c.indexOf("statusCode\":\"251")!=-1){
                                    //$.iMessager.alert('操作提示','操作成功！','question',function(r){
                                    //location.reload();
                                    //  });
                                    $.iMessager.confirm('操作提示','操作成功！是否跳转到采购单页面？',function(r){
                                        if (r){
                                            location.reload();
                                            var strs= new Array();
                                            var str=c.message;
                                            ...
                                            var x=strs[3];
                                            var z=strs[4];
                                            window.open("/Purchase/printing/?url=/baobiao/purchaseOrder2&purchaseAccount="+s+"&orderAccount="+t+"&supplierId="+y+"&taiId="+x+"&caigouUrl="+z);
                                            // /Purchase/printing/?url=/baobiao/purchaseOrder2&purchaseAccount={multiple.purchaseId}&supplierId={multiple.supplierId}&taiId={multiple.taiId}
                                        }else{
                                            location.reload();
                                        }
                                    });
                                    ...
                                    console.log('莫名其妙');
                                    $.iMessager.alert('警告',c.message);
                                }

                                var c = strToJson(c);
                                if (c.statusCode == topJUI.config.statusCode.success || c.statusCode == 250 || c.statusCode == 251) {
                                    if(c.statusCode ==topJUI.config.statusCode.success){
                                        ...
                                        if (b.form.closeCurrentTab) {
                                            var h = d.tabs("getSelected"),
                                                i = d.tabs("getTabIndex", h);
                                            d.tabs("close", i)
                                        }
                                    }
                        ...
                        if (arrayContain(d, b.handler)) {
                            if ("ajaxForm" == b.handler || "multiAjaxForm" == b.handler) {
                                ...
                                var e = "menu-item" == b.menuType ? strToJson("{" + a("#" + b.mbId).data().options + "}") : a("#" + b.mbId).iMenubutton("options"),
                                    f = a(e.extend),
                                    g = f.length > 0 ? getOptionsJson(f) : {};
                                e = a.extend(!0, g, e);
                                var h = {
                                        reload: !0
                                    },
                                    i = a.extend(a("#" + e.grid.id)[e.grid.type]("options"), h, e.grid);
                                e.dialog;
                                if (a("#" + b.dialogId).form("validate")) {
                                    if (b.ajaxData = a("#" + b.dialogId).serialize(), "multiAjaxForm" == b.handler) {
                                        ...
                                        void 0 == i.param && (i.param = topJUI.config.pkName + ":" + topJUI.config.pkName),
                                            b.ajaxData += "&" + convertParamObj2Serialize(param2JsonObj(i.param), j)
                                    }
                                    var k = doAjax(b);
                                    if (k.statusCode == topJUI.config.statusCode.success) {
                                        if (a("#" + b.dialogId).dialog("close"), "object" == typeof i && 1 == i.reload) if ("datagrid" == i.type) a("#" + i.id).datagrid("reload");
                                        else if ("treegrid" == i.type) {
                                            var l = getSelectedRowData(i.type, i.id),
                                                m = a("#" + i.id).treegrid("getRoots"),
                                                n = !1;
    ...
    function(a) {
        a.fn.iMaskedbox = function(b, c) {
            ...
            this.each(function() {
                b = a.fn.iMaskedbox.parseOptions(this, b),
                    a(this).maskedbox(b)
            })
        },
            a.fn.iMaskedbox.methods = {},
            a.fn.iMaskedbox.parseOptions = function(b, c) {
                var d = a.extend({},
                    a.fn.maskedbox.parseOptions(b), a.fn.iMaskedbox.defaults, a.parser.parseOptions(b, ["id", "value"]), c);
                return setId(b, d)
            },
    ...
    function(a) {
        a.fn.iPropertygrid = function(b, c) {
            ...
            this.each(function() {
                b = a.fn.iPropertygrid.parseOptions(this, b),
                    a(this).propertygrid(b)
            })
        },
            a.fn.iPropertygrid.methods = {},
            a.fn.iPropertygrid.parseOptions = function(b, c) {
                var d = a.extend({},
                    a.fn.propertygrid.parseOptions(b), a.fn.iPropertygrid.defaults, a.parser.parseOptions(b, ["id", "value"]), c);
                return setId(b, d)
            },
    ...
    function(a) {
        a.fn.iRadiobutton = function(b, c) {
            ...
            this.each(function() {
                b = a.fn.iRadiobutton.parseOptions(this, b),
                    a(this).radiobutton(b)
            })
        },
            a.fn.iRadiobutton.methods = {},
            a.fn.iRadiobutton.parseOptions = function(b, c) {
                var d = a.extend({},
                    a.fn.radiobutton.parseOptions(b), a.fn.iRadiobutton.defaults, a.parser.parseOptions(b, ["id", "value"]), c);
                return setId(b, d)
            },
    ...
    function(a) {
        a.fn.iSidemenu = function(b, c) {
            ...
            this.each(function() {
                b = a.fn.iSidemenu.parseOptions(this, b),
                    a(this).sidemenu(b)
            })
        },
            a.fn.iSidemenu.methods = {},
            a.fn.iSidemenu.parseOptions = function(b, c) {
                var d = a.extend({},
                    a.fn.sidemenu.parseOptions(b), a.fn.iSidemenu.defaults, a.parser.parseOptions(b, ["id", "value"]), c);
                return setId(b, d)
            },
                ...
                onSelect: function(b, c) {
                    ...
                    if (null != g.href || null != g.iframeHref) {
                        ...
                        i.length > 0 ? i.each(function(b) {
                            ...
                            a("#" + c.id);
                            "object" == typeof e && setGridQueryParams(e, "datagrid", c.id),
                                a(this).iEdatagrid("options").url = d,
                                a(this).iDatagrid("load"),
                                g.dgOpts = c
                        }) : "object" == typeof g.dgOpts && ("object" == typeof e && setGridQueryParams(e, g.dgOpts.type, g.dgOpts.id), a("#" + g.dgOpts.id)[g.dgOpts.type]("reload")),
                    ...
                    if ("object" == typeof c.childGrid) {
                        ...
                        for (var e = c.childGrid.grid,
                            ...
                            if ("datagrid" == e[f].type || "treegrid" == e[f].type) {
                                ...
                                g[e[f].type]("options").queryParams = a.extend({},
                                    h, d),
                                    g[e[f].type]("load")
